...
public class InterfazAlcancia extends JFrame {
    ...
    /**
     * Construye la interfaz de la aplicaci�n y la inicializa con una alcanc�a
     * vac�a. <br>
     * <b>post: </b> Se inicializ� la ventana principal de la aplicaci�n con sus
     * paneles.
     */
     ...
     * <b>post: </b> Se agreg� la cantidad indicada a la alcanc�a o se present� un
     * mensaje de error si estaba rota.
     * 
     * @param pDenominacion Denominaci�n de la moneda que se va a agregar a la
     *                      alcanc�a. pDenominacion >0.
     */
    public void agregarMoneda(int pDenominacion) {
        if (alcancia.darEstado().equals("NO ROTA")) {
            ...
            panelAlcancia.cambiarMensaje("Se agregaron $" + pDenominacion + " a la alcanc�a.\nEn la alcanc�a hay $"
                    + alcancia.calcularTotalDinero() + " pesos.");
        } else {
            JOptionPane.showMessageDialog(this, "No se pueden agregar monedas a una alcanc�a rota.", "Agregar moneda",
